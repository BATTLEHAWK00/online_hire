...
class questionnaireModel {
    static async getByID(_id: string) {
        const questionnaire = await coll.findOne({_id: new ObjectId(_id), deleted: {$ne: true}})
    ...
    static async updateQuestionnaire(_id: string, $set: Partial<Questionnaire>, $unset?: Partial<Questionnaire> | null) {
        const op: any = {};
